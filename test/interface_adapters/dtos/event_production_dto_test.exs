defmodule FoodOrderProducao.InterfaceAdapters.DTOs.EventProductionDTOTest do
  ...
  describe "from_json/1" do
    test "successfully converts JSON to DTO" do
      json =
        ~s({"Id":1,"NumeroPedido":1,"TempoEspera":"00:00:00","DataCriacao":"2025-05-20T00:20:41.380145Z","ClienteId":"00000000-0000-0000-0000-000000009999","PedidoStatus":0,"PagamentoStatus":0,"SacolaId":1,"Produtos":["prod-1","prod-2"]})
    ...
    test "returns error for invalid JSON" do
      ...
      assert {:error, "Invalid event production data - unknown fields"} =
               EventProductionDTO.from_json(json)
    end
  end
